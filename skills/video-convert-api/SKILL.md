...
- `POST https://gateway.pixazo.ai/media-tools/v1/convert`

**Sample request (primary operation)**

```bash
curl -X POST 'https://gateway.pixazo.ai/media-tools/v1/convert' \
...
import os, requests
r = requests.post(
    "https://gateway.pixazo.ai/media-tools/v1/convert",
    headers={
...
```js
const res = await fetch('https://gateway.pixazo.ai/media-tools/v1/convert', {
  method: 'POST',
  headers: {
