...
| Kling Video O3 4K | Video to Video Reference | `kling-video-o3-4k` / `v2v-reference` |
| Kling Video O3 4K | Video to Video Edit | `kling-video-o3-4k` / `v2v-edit` |
...
| Kling 2.6 Standard | Video to Video (Video Editing — Motion Control) | `kling-video-v2-6-standard-motion-control` / `kling-video-v2-6-standard-motion-control-request` |
| Kling Virtual Try-on | Image to Image (Virtual Try On) | `kling-virtual-try-on` / `generate-image-request` |
| Kling 1.6 | Image to Video | `klingai-video` / `image-to-video-request` |
| Kling 1.6 | Text to Video | `klingai-video` / `video-request` |
...
- **Other video generation models:** `sync-lipsync`, `happy-horse`, `p-video`, `seedance`, `sora`, `veo`, `runway`, `pika`, `higgsfield`, `genflare`, `omnihuman`, `lucy-edit`, `ltx`, `luma`, `mochi`, `veed`, `vidu`, `wan`, `minimax`, `pixverse`, `kandinsky`, `hunyuan-video`, `heygen`, `grok-imagine-video`, `gemini-omni`, `gemini-omni-1-1`, `cosmos`, `video-to-previs`, `magi`, `vibeo`
