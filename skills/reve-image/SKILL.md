---
name: reve-image
description: Image generation/editing with Reve Image API (by Reve) via the Pixazo API. TRIGGER when the user mentions "Reve Image" or "Reve Image API", or when the user asks to generate / make / create / edit / restyle an image and Reve Image is named or implied. DO NOT TRIGGER for video / music / voice / 3d / try-on — each has its own skill.
---
...
> **Fetch:** `https://www.pixazo.ai/models/reve-image.md`

Load that URL when you need exact parameter names, accepted values, or aren't sure about a field. The HTML version is at `https://www.pixazo.ai/models/reve-image`.

---

## Related Pixazo skills

- **Other image generation/editing models:** `seedream`, `flux`, `gpt-image`, `grok-imagine-image`, `ideogram`, `longcat-image`, `nano-banana`, `pixelforge`, `qwen-image`, `recraft`, `studio-ghibli`, `auraflow`, `z-image`, `bria`, `sdxl`, `firered-image-edit`, `codeformer`, `gfpgan`, `smart-resize`, `nucleus`, `glm-image`, `hidream`, `ernie-image`, `mirelo`, `real-esrgan`
