...
|---|---|---|
| v2 | Text to Speech | `xtts-v2-api` / `text-to-speech-request` |
...
- **Other text-to-speech / voice synthesis models:** `chatterbox`, `vibevoice`, `elevenlabs`, `gemini`, `qwen-tts`, `openbmb-voxcpm2`
