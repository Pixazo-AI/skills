...
- **Other text-to-speech / voice synthesis models:** `chatterbox`, `vibevoice`, `xtts`, `elevenlabs`, `gemini`, `qwen-audio`, `voxcpm`, `zonos`, `fish-audio`, `inworld`, `xai-tts`, `lux-tts`, `tada`, `melotts`, `gpt-4o`
