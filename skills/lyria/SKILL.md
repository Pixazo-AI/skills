---
name: lyria
description: Music/audio generation with Lyria API (by Google) via the Pixazo API. TRIGGER when the user mentions "Lyria" or "Lyria API", or when the user asks to generate / make music / a song / a beat / audio track and Lyria is named or implied. DO NOT TRIGGER for image / video / voice / 3d / try-on — each has its own skill.
---

# Lyria API

Google's advanced AI music generation model for creating high-quality audio content.

You can ask Lyria to handle music/audio generation. Powered by Google via the Pixazo API gateway.
...
> **Fetch:** `https://www.pixazo.ai/models/lyria.md`
...
Load that URL when you need exact parameter names, accepted values, or aren't sure about a field. The HTML version is at `https://www.pixazo.ai/models/lyria`.

---

## Related Pixazo skills

- **Other music/audio generation models:** `tracks`, `ace-step`, `mmaudio`, `stable-audio`
